...
const WA_URL =
  "https://wa.me/447999500184?text=Hi%20Christopher%2C%20I%20found%20your%20ppc-consultant%20page%20and%20I%27d%20like%20to%20discuss%20my%20Google%20Ads.";

export default function PPCConsultantPage() {
  ...
  const trackFormSubmit = () => {
    if (typeof window !== "undefined" && (window as any).gtag) {
      (window as any).gtag("event", "form_submit", {
        ...
        event_label: "ppc-google-adwords-consultant - contact form",
      });
      (window as any).gtag("event", "conversion", {
    ...
    try {
      const response = await fetch("/api/leads", {
        ...
        body: JSON.stringify({
          ...
          source: "ppc-google-adwords-consultant",
        }),
      });
  ...
  const faqs = [
    {
      q: "What size accounts does a paid search consultant like you work with?",
      a: "UK businesses spending between \u00a32,000 and \u00a3100,000/month on Google Ads. I focus on accounts where senior pay per click consultant attention makes a meaningful difference to results.",
    },
    {
      q: "What\u2019s involved in the free waste report?",
      a: "You give me read-only access to your Google Ads account. I manually review your campaigns, keywords, search terms, bidding, tracking, and conversion data. I send you a plain-English report within 24 hours. No tools, no automation \u2014 just a senior Google Ads consultant looking at your account.",
    },
    {
      q: "How is an AdWords consultant different from an agency?",
      a: "An agency spreads junior staff across dozens of accounts. A Google AdWords consultant like me works with a maximum of four clients at any time, giving your account the senior-level focus it needs. Every decision is made by a PPC consultant with 16 years of hands-on experience.",
    },
    {
    ...
    <div className="ppc-lp">
        ...
        <div className="hero-layout">
          <div className="hero-content">
            <div className="hero-eyebrow">
              PPC Consultant &middot; Senior Level &middot; UK
            </div>
            <h1>
              Looking for a PPC consultant?<br /> Is your Google Ads budget being <em>wasted?</em> Find out free.
            </h1>
            <p className="hero-sub">
              I&apos;m a senior Google Ads consultant and pay per click consultant with 16 years of hands-on experience.
            ...
            <div className="hero-person">
              ...
              <div className="hero-person-text">
                ...
                <div className="hero-person-sub">
                  Senior PPC Consultant &middot; 16 years &middot; £50M+ managed
                </div>
              </div>
            </div>
            <div className="cta-stack">
              <a
                ...
                className="btn-wa"
                onClick={() => trackWhatsApp("ppc-consultant - hero")}
              >
          ...
          <div className="hero-desktop-photo">
            <img
              src="/christopher-headshot.jpg"
              alt="Christopher Hoole — Senior PPC Consultant & Google Ads Consultant"
            />
          </div>
        </div>
      </section>
      ...
      <section className="section">
        ...
        <p className="section-intro">
          ...
          <br />
          Here&apos;s exactly what a senior PPC consultant looks at:
        </p>
        ...
        <div style={{ marginTop: "28px" }}>
          <a
            ...
            onClick={() => trackWhatsApp("ppc-consultant - waste-report")}
          >
      ...
      <section className="section alt">
        ...
        <div className="who-list">
          {[
            ...
            "You\u2019re not getting the results your agency or current gads consultant promised",
            "You want a senior paid search consultant \u2014 not a junior exec \u2014 looking at your account",
          ].map((text) => (
      ...
      <section className="section">
        ...
        <h2>Why a senior Google Ads consultant beats an agency</h2>
        <div className="agency-layout">
          ...
          <div className="compare-table">
            ...
            {[
              ["Junior exec, 30+ accounts", "Senior gads consultant. Personal."],
      ...
      <section className="form-section" id="contact">
        ...
        >
          ...
          with a dedicated Google Ads consultant &mdash; get in touch today.
        </p>
        ...
        <div className="wa-card">
          ...
          <a
            ...
            rel="noopener noreferrer"
            className="btn-wa"
            onClick={() => trackWhatsApp("ppc-consultant - contact")}
          >
            Message on WhatsApp ⚡
          </a>
        </div>
        ...
        <div className="process-list">
          {[
            ...
            },
            {
              ...
              desc: "If you want to work with a dedicated adwords consultant, we book a 30-minute call. No hard sell. No obligation.",
            },
          ].map((step, i) => (
      ...
      <footer className="footer">
        ...
        <div className="footer-tagline">
          Senior PPC Consultant &middot; Google Ads Consultant &middot; Pay Per Click &amp; Paid Search Consultant &middot; Maximum 4
          clients.
        </div>
      ...
      <div className="sticky">
        <a
          ...
          rel="noopener noreferrer"
          className="sticky-wa"
          onClick={() => trackWhatsApp("ppc-consultant - sticky")}
        >
          💬 Get my free waste report
        </a>
