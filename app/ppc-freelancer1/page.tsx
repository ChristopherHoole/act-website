...
const WA_URL =
  "https://wa.me/447999500184?text=Hi%20Christopher%2C%20I%20found%20your%20ppc-freelancer%20page%20and%20I%27d%20like%20to%20discuss%20my%20Google%20Ads.";

export default function PPCFreelancer1Page() {
  ...
  const trackFormSubmit = () => {
    if (typeof window !== "undefined" && (window as any).gtag) {
      (window as any).gtag("event", "form_submit", {
        ...
        event_label: "ppc-freelancer1 - contact form",
      });
      (window as any).gtag("event", "conversion", {
  ...
  const faqs = [
    {
      ...
      a: "UK businesses spending between £2,000 and £100,000/month on Google Ads. I focus on accounts where senior specialist attention makes a meaningful difference to results.",
    },
    {
      q: "What\u2019s involved in the free waste report?",
      a: "You give me read-only access to your Google Ads account. I manually review your campaigns, keywords, search terms, bidding, tracking, and conversion data. I send you a plain-English report within 24 hours. No tools, no automation \u2014 just a senior specialist looking at your account.",
    },
    {
  ...
  return (
    <div className="ppc-lp">
        ...
        <div className="hero-layout">
          <div className="hero-content">
            <div className="hero-eyebrow">
              PPC Freelancer &middot; Senior Level &middot; UK
            </div>
            <h1>
              Is your Google Ads budget being <em>wasted?</em> Find out free.
            </h1>
            <p className="hero-sub">
              I&apos;ll analyse your Google Ads account and send you a
              plain-English waste report &mdash; showing exactly where your
              budget is going and what to fix. Free. No obligation. 10 minutes of
              your time.
            </p>
            <div className="hero-person">
              ...
              <div className="hero-person-text">
                ...
                <div className="hero-person-sub">
                  Senior PPC Freelancer &middot; 16 years &middot; £50M+ managed
                </div>
              </div>
            </div>
            <div className="cta-stack">
              <a
                ...
                className="btn-wa"
                onClick={() => trackWhatsApp("ppc-freelancer1 - hero")}
              >
          ...
          <div className="hero-desktop-photo">
            <img
              src="/christopher-headshot.jpg"
              alt="Christopher Hoole — Senior PPC Freelancer"
            />
          </div>
        </div>
      </section>
      ...
      <section className="section">
        ...
        <div style={{ marginTop: "28px" }}>
          <a
            ...
            onClick={() => trackWhatsApp("ppc-freelancer1 - waste-report")}
          >
      ...
      <section className="section alt">
        ...
        <div className="who-list">
          {[
            ...
            "You want a senior specialist \u2014 not a junior exec \u2014 looking at your account",
          ].map((text) => (
      ...
      <section className="section">
        ...
        <h2>Why a senior PPC freelancer beats an agency</h2>
        <div className="agency-layout">
          ...
          <div className="compare-table">
            ...
            {[
              ["Junior exec, 30+ accounts", "Senior specialist. Personal."],
      ...
      <section className="form-section" id="contact">
        ...
        >
          ...
          together &mdash; get in touch today.
        </p>
        ...
        <div className="wa-card">
          ...
          <a
            ...
            rel="noopener noreferrer"
            className="btn-wa"
            onClick={() => trackWhatsApp("ppc-freelancer1 - contact")}
          >
            Message on WhatsApp ⚡
          </a>
        </div>
        ...
        <div className="process-list">
          {[
            ...
            },
            {
              ...
              desc: "If you want to work together, we book a 30-minute call. No hard sell. No obligation.",
            },
          ].map((step, i) => (
      ...
      <footer className="footer">
        ...
        <div className="footer-tagline">
          Senior PPC Freelancer &middot; Proprietary AI &middot; Maximum 4
          clients.
        </div>
      ...
      <div className="sticky">
        <a
          ...
          rel="noopener noreferrer"
          className="sticky-wa"
          onClick={() => trackWhatsApp("ppc-freelancer1 - sticky")}
        >
          💬 Get my free waste report
        </a>
